defmodule Outstanding.KeywordOfMapTest do
  ...
  gen_nothing_outstanding_test("realized with extra item in child map", [x: %{a: "a"}, y: %{b: "b"}], [x: %{a: "a"}, y: %{b: "b"}, z: %{b: "b", c: "c"}])
  ...
  gen_result_outstanding_test("nil value result", [x: &Outstand.explicit_nil/1, y: %{b: "b"}], [x: %{b: "b"}, y: %{b: "b"}], [x: :explicit_nil])
