...
defmodule Outstanding.MapTest do
  ...
  gen_something_outstanding_test("key explicit nil value outstanding, not nil", %{x: :a, y: &Outstand.explicit_nil/1}, %{
    x: :a,
    y: :c,
    z: :b
  })
  ...
  gen_result_outstanding_test("key explicit nil result, no value", %{x: :a, y: &Outstand.explicit_nil/1}, %{x: :a, z: :b}, %{
    y: :explicit_nil
  })

  gen_result_outstanding_test("key explicit nil result, not nil", %{x: :a, y: &Outstand.explicit_nil/1}, %{x: :a, y: :c, z: :b}, %{
    y: :explicit_nil
  })
